...
#__C.CONST.WEIGHTS                           = '/content/drive/MyDrive/Colab Assets/SwinVox/SwinVox_Best_Weight/checkpoint-best.pth'   # if training is resuming, uncomment this replace 'path' with weight path.
