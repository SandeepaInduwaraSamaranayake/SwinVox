...
__C.TRAIN.ENCODER_LEARNING_RATE             = 2.5e-4 # default is 1e-3
__C.TRAIN.DECODER_LEARNING_RATE             = 2.5e-4 # default is 1e-3
__C.TRAIN.REFINER_LEARNING_RATE             = 2.5e-4 # default is 1e-3
__C.TRAIN.MERGER_LEARNING_RATE              = 2.5e-5 # default is 1e-4
