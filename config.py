...
__C.TRAIN.ENCODER_LEARNING_RATE             = 1e-3 # default is 1e-3
__C.TRAIN.DECODER_LEARNING_RATE             = 1e-3 # default is 1e-3
__C.TRAIN.REFINER_LEARNING_RATE             = 1e-3 # default is 1e-3
__C.TRAIN.MERGER_LEARNING_RATE              = 1e-4 # default is 1e-4
